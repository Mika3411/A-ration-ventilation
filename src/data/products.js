...
import pressureControlGmaxEpc12 from "../assets/product-pressure-control-gmax-epc-12.jpg";

import pressureSwitchGmaxKrs7 from "../assets/product-pressure-switch-gmax-krs-7.jpg";

import pressureSwitchGmaxPc9 from "../assets/product-pressure-switch-gmax-pc-9.jpg";
...
import { normalizeQuantityDiscounts } from "../../shared/pricing.js";
...
export const productImageOptions = [
  ...
  { label: "Contrôleur de pression Gmax EPC-12", value: "pressureControlGmaxEpc12" },
  { label: "Interrupteur de pression Gmax KRS-7", value: "pressureSwitchGmaxKrs7" },
...
const pressureSwitchGmaxKrs7Product = {
  ...
  amount: 0,
  price: "Prix sur demande",
  text: "Interrupteur de pression mécanique combiné à trois voies Gmax KRS-7 avec manomètre, conçu pour automatiser la mise en marche et l'arrêt d'une pompe selon la pression. Les réglages d'usine démarrent la pompe à 1,35 bar et l'arrêtent à 2,75 bar; la plage de réglage permet d'ajuster le fonctionnement entre 1,1 et 5,5 bar. Prêt à être installé directement à la sortie de la pompe, il intègre un manomètre de contrôle et dispose d'une entrée et de deux sorties 1 pouce pour raccorder le réservoir d'expansion et l'alimentation de la pompe. Installation verticale uniquement. Raccord 1 pouce, fréquence 50-60 Hz, tension 220-240 V, courant maximal 16 A, pression maximale 5,5 bar et température d'eau jusqu'à 55 °C.",
  featured: true,
  active: true,
  sortOrder: 99,
};
